<tr>
                                                    ...
                                                    <td>  <?php
                                                        ...
                                                        <div id="download_<?=$tipo?>"style="display:<?=$file?'':'none'?>"  >
                                                            ...
                                                            <button id="info_<?=$tipo?>"type="button" onclick="infoAlleIstanza(<?=$alle['id']?>);"class="btn btn-warning btn-xs" title="Visualizza Info Allegato"style="padding-left:12px;padding-right:12px;"><i class="fa fa-list" aria-hidden="true"></i></button>
                                                            ...
                                                            <?php
                                                                   if(!isUserAdmin()&&$rend['aperta']==1||!$disable_istr){?>
